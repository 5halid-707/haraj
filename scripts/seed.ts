...
async function main() {
  ...
  // Clean existing data
  await db.trustedPurchase.deleteMany();
  ...
  const categories = [
    { name: "السيارات", slug: "cars", icon: "🚗", children: [
      ...
      { name: "قطع غيار وملحقات", slug: "car-parts", icon: "🔧" },
      { name: "شاحنات ومعدات ثقيلة", slug: "trucks", icon: "🚚" },
      { name: "دبابات", slug: "motorcycles", icon: "🏍️" },
      { name: "سيارات تراثية", slug: "classic-cars", icon: "🚗" },
      { name: "سيارات مصدومة", slug: "damaged-cars", icon: "🚗" },
      { name: "سيارات للتنازل", slug: "lease-transfer", icon: "🚗" },
      { name: "أرقام مميزة", slug: "vip-plates", icon: "🔢" },
    ]},
    { name: "العقارات", slug: "realestate", icon: "🏠", children: [
      { name: "شقق للبيع", slug: "apartments-sale", icon: "🏢" },
      { name: "شقق للايجار", slug: "apartments-rent", icon: "🏢" },
      { name: "فلل للبيع", slug: "villas-sale", icon: "🏡" },
      { name: "فلل للايجار", slug: "villas-rent", icon: "🏡" },
      { name: "أراضي للبيع", slug: "lands-sale", icon: "🌳" },
      { name: "أراضي تجارية للبيع", slug: "commercial-lands", icon: "🏭" },
      { name: "عمارة للايجار", slug: "buildings-rent", icon: "🏬" },
      { name: "محلات للايجار", slug: "shops-rent", icon: "🏪" },
      { name: "محلات للبيع", slug: "shops-sale", icon: "🏪" },
      { name: "استراحات للبيع", slug: "farms-sale", icon: "🌴" },
      { name: "بيوت للبيع", slug: "houses-sale", icon: "🏠" },
      { name: "بيوت للايجار", slug: "houses-rent", icon: "🏠" },
      { name: "أدوار للايجار", slug: "floors-rent", icon: "🏠" },
    ]},
    ...
    { name: "الأثاث", slug: "furniture", icon: "🛋️", children: [
      ...
      { name: "مكاتب", slug: "offices", icon: "🪑" },
      { name: "ديكور", slug: "decor", icon: "🖼️" },
    ]},
    { name: "أزياء", slug: "fashion", icon: "👗", children: [
      { name: "ملابس رجالية", slug: "mens-clothing", icon: "👔" },
      { name: "ملابس نسائية", slug: "womens-clothing", icon: "👗" },
      { name: "ملابس أطفال", slug: "kids-clothing", icon: "👶" },
      { name: "أحذية", slug: "shoes", icon: "👟" },
      { name: "حقائب", slug: "bags", icon: "👜" },
      { name: "ساعات", slug: "watches", icon: "⌚" },
      { name: "عطور", slug: "perfumes", icon: "🌸" },
    ]},
    { name: "حيوانات", slug: "animals", icon: "🐕", children: [
      { name: "إبل", slug: "camels", icon: "🐪" },
      { name: "خيول", slug: "horses", icon: "🐎" },
      { name: "طيور", slug: "birds", icon: "🦜" },
      { name: "أغنام", slug: "sheep", icon: "🐑" },
      { name: "حيوانات أليفة", slug: "pets", icon: "🐱" },
      { name: "أسماك وأحواض", slug: "fish", icon: "🐟" },
    ]},
    { name: "وظائف", slug: "jobs", icon: "💼", children: [
      ...
      { name: "ممرض", slug: "nurse", icon: "💉" },
      { name: "طباخ", slug: "cook", icon: "👨‍🍳" },
      { name: "حارس أمن", slug: "security", icon: "👮" },
      { name: "بائع", slug: "salesman", icon: "🛒" },
    ]},
    { name: "خدمات", slug: "services", icon: "🔧", children: [
      { name: "نقل عفش", slug: "moving", icon: "📦" },
      { name: "صيانة", slug: "maintenance", icon: "🛠️" },
      { name: "تنظيف", slug: "cleaning", icon: "🧹" },
      { name: "تكييف", slug: "ac-service", icon: "❄️" },
      { name: "كهرباء", slug: "electrician", icon: "💡" },
      { name: "سباكة", slug: "plumbing", icon: "🚿" },
      { name: "دعوة وليمة", slug: "catering", icon: "🍽️" },
    ]},
    { name: "ألعاب", slug: "games", icon: "🎮", children: [
      { name: "بلايستيشن", slug: "playstation", icon: "🎮" },
      { name: "إكس بوكس", slug: "xbox", icon: "🎮" },
      { name: "نينتندو", slug: "nintendo", icon: "🎮" },
      { name: "ألعاب لوحية", slug: "board-games", icon: "🎲" },
    ]},
    { name: "تدريب", slug: "training", icon: "🎓", children: [
      { name: "دورات", slug: "courses", icon: "📖" },
      { name: "تدريب قيادة", slug: "driving", icon: "🚗" },
      { name: "تدريب رياضي", slug: "fitness", icon: "💪" },
      { name: "لغات", slug: "languages", icon: "🌍" },
    ]},
    { name: "أطعمة", slug: "food", icon: "🍽️", children: [
      { name: "تمور", slug: "dates", icon: "🌴" },
      { name: "عسل", slug: "honey", icon: "🍯" },
      { name: "بهارات", slug: "spices", icon: "🌶️" },
      { name: "مكسرات", slug: "nuts", icon: "🥜" },
      { name: "ألبان", slug: "dairy", icon: "🥛" },
    ]},
    { name: "مناسبات", slug: "events", icon: "🎉", children: [
      { name: "تنظيم حفلات", slug: "party-planning", icon: "🎈" },
      { name: "قاعات مناسبات", slug: "halls", icon: "🏛️" },
      { name: "تصوير", slug: "photography", icon: "📷" },
      { name: "فرق شعبية", slug: "folk-groups", icon: "🎶" },
    ]},
    { name: "برمجة", slug: "programming", icon: "💻", children: [
      { name: "تصميم مواقع", slug: "web-design", icon: "🌐" },
      { name: "تطبيقات جوال", slug: "mobile-apps", icon: "📱" },
      { name: "تسويق رقمي", slug: "digital-marketing", icon: "📈" },
      { name: "تصميم جرافيك", slug: "graphic-design", icon: "🎨" },
    ]},
    { name: "حدائق", slug: "gardens", icon: "🌳", children: [
      { name: "نباتات", slug: "plants", icon: "🪴" },
      { name: "أشجار", slug: "trees", icon: "🌲" },
      { name: "بذور", slug: "seeds", icon: "🌱" },
      { name: "أدوات حدائق", slug: "garden-tools", icon: "🪓" },
    ]},
    { name: "نوادر", slug: "rare-items", icon: "💎", children: [
      { name: "تحف وآثار", slug: "antiques", icon: "🏺" },
      { name: "عملات", slug: "coins", icon: "🪙" },
      { name: "طوابع", slug: "stamps", icon: "📮" },
      { name: "نوادر أخرى", slug: "other-rare", icon: "💎" },
    ]},
    { name: "مشاريع واستثمارات", slug: "investments", icon: "📈", children: [
      { name: "مشاريع جاهزة", slug: "ready-projects", icon: "🏗️" },
      { name: "شراكة", slug: "partnership", icon: "🤝" },
      { name: "امتياز تجاري", slug: "franchise", icon: "🏪" },
    ]},
    { name: "الفنون", slug: "arts", icon: "🎨", children: [
      { name: "لوحات", slug: "paintings", icon: "🖼️" },
      { name: "خط عربي", slug: "calligraphy", icon: "✒️" },
      { name: "منحوتات", slug: "sculptures", icon: "🗿" },
      { name: "أدوات فنية", slug: "art-supplies", icon: "🖌️" },
    ]},
    { name: "الرحلات", slug: "trips", icon: "✈️", children: [
      { name: "عمرة وحج", slug: "umrah", icon: "🕌" },
      { name: "رحلات سياحية", slug: "tourism-trips", icon: "🗺️" },
      { name: "حجوزات طيران", slug: "flights", icon: "✈️" },
      { name: "فنادق", slug: "hotels", icon: "🏨" },
    ]},
    { name: "سياحة", slug: "tourism", icon: "🌍", children: [
      { name: "عقارات سياحية", slug: "tourism-real-estate", icon: "🏝️" },
      { name: "باقات سياحية", slug: "tour-packages", icon: "📋" },
      { name: "تأشيرات", slug: "visas", icon: "🛂" },
    ]},
    { name: "مفقودات", slug: "lost-found", icon: "🔍", children: [
      { name: "مفقودات", slug: "lost", icon: "❓" },
      { name: "موجودات", slug: "found", icon: "✅" },
      { name: "أشخاص مفقودون", slug: "missing-persons", icon: "👤" },
    ]},
  ];
  ...
  const users = [
    { username: "أبو سطام", phone: "0575015019", email: "khalid-alharbi@zohomail.sa", city: "جدة", isVerified: true, isAdmin: true, rating: 5.0, affiliateCode: "SATTAM100" },
  ...
  const listings = [
    ...
    // ===== SERVICES =====
    {
      ...
      images: ["https://images.unsplash.com/photo-1600518464441-9154a4dea21b?w=800&q=80"],
      username: "أبو ناصر",
      isFeatured: true,
      whatsapp: "0542233445",
    },
    {
      ...
      images: ["https://images.unsplash.com/photo-1631545308456-7d1c6a4d2bca?w=800&q=80"],
      username: "أبو عبدالله",
      whatsapp: "0557654321",
    },
    {
