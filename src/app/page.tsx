      ...
      <DialogContent className="sm:max-w-md">
        ...
        <Tabs value={tab} onValueChange={(v) => setTab(v as "login" | "register")}>
          ...
          <TabsContent value="login" className="space-y-3 mt-4">
            <div><Label>{t("auth.emailOrPhone", lang)}</Label><Input value={login.identifier} onChange={(e) => setLogin({ ...login, identifier: e.target.value })} placeholder="khalid-alharbi@zohomail.sa" onKeyDown={(e) => { if (e.key === "Enter") handleLogin(); }} /></div>
            ...
            <div className="bg-zinc-50 rounded-lg p-3 text-xs text-zinc-600 text-center"><p className="font-bold mb-1">{t("auth.demoAccounts", lang)}</p><p>khalid-alharbi@zohomail.sa / Admin@2026</p><p>saad@example.com / 123456</p><p>ahmed@driver.com / 123456</p></div>
          </TabsContent>
